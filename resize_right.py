...
# except ImportError:
#     numpy = None
# namanh: there's no way we don't have numpy
import numpy
...
"""
namanh: convenience for typechecking
"""
from typing import Literal
from functools import lru_cache
InterpMethodName = Literal["cubic", "box", "linear", "lanczos2", "lanczos3"]

@lru_cache()
def get_interp_method(name: InterpMethodName):
    if name == "cubic":
        return cubic
    elif name == "box":
        return box
        ...
        raise ValueError("unknkown interp method")
# end namanh new code
